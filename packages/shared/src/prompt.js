...
function forumDiscussionBlock(item, fetchWindow) {
...
function itemPromptBlock(item, fetchWindow) {
    const lines = [
        `### ${item.title}`,
...
export function renderPromptItems(items, fetchWindow) {
...
export function fillPromptTemplate(template, items, fetchWindow) {
